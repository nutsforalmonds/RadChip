...
void initialize(int argc, char *argv[])
{
	...
	////platform_01->setSpeed(5);
	//platform_01->setKd(vec3(.4, 0, 0));
	//platform_01->setKa(vec3(.4, 0, 0));
	//platform_01->setKs(vec3(.4, 0, 0));
	//platform_01->setShininess(100);
	//platform_01->setFog(fog);
	//platform_01->setReflectFactor(vec2(0.2, 0.5));
	//platform_01->setEta(0.5);
	...
	////platform_01->setSpeed(5);
	//platform_02->setKd(vec3(.4, 0, 0));
	//platform_02->setKa(vec3(.4, 0, 0));
	//platform_02->setKs(vec3(.4, 0, 0));
	//platform_02->setShininess(100);
	//platform_02->setFog(fog);
	//platform_02->setReflectFactor(vec2(0.2, 0.5));
	//platform_02->setEta(0.5);
	...
	////platform_01->setSpeed(5);
	//platform_03->setKd(vec3(.4, 0, 0));
	//platform_03->setKa(vec3(0.4, 0, 0));
	//platform_03->setKs(vec3(0.4, 0, 0));
	//platform_03->setShininess(100);
	//platform_03->setFog(fog);
	//platform_03->setReflectFactor(vec2(0.2, 0.5));
	//platform_03->setEta(0.5);
	...
	////platform_01->setSpeed(5);
	//platform_04->setKd(vec3(.4, 0, 0));
	//platform_04->setKa(vec3(.4, 0, 0));
	//platform_04->setKs(vec3(.4, 0, 0));
	//platform_04->setShininess(100);
	//platform_04->setFog(fog);
	//platform_04->setReflectFactor(vec2(0.2, 0.5));
	//platform_04->setEta(0.5);
	...
	////platform_05->setSpeed(5);
	//platform_05->setKd(vec3(0.4, 0, 0));
	//platform_05->setKa(vec3(0.4, 0, 0));
	//platform_05->setKs(vec3(0.4, 0, 0));
	//platform_05->setShininess(100);
	//platform_05->setFog(fog);
	//platform_05->setReflectFactor(vec2(0.2, 0.5));
	//platform_05->setEta(0.5);
	...
	////platform_06->setSpeed(5);
	//platform_06->setKd(vec3(0.4, 0.0, 0));
	//platform_06->setKa(vec3(0.4, 0.0, 0));
	//platform_06->setKs(vec3(0.4, 0.0, 0));
	//platform_06->setShininess(100);
	//platform_06->setFog(fog);
	//platform_06->setReflectFactor(vec2(0.2, 0.5));
	//platform_06->setEta(0.5);
	...
	//Cube* platform_07 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	////platform_07->setSpeed(5);
	//platform_07->setKd(vec3(0.4, 0, 0));
	//platform_07->setKa(vec3(0.4, 0, 0));
	//platform_07->setKs(vec3(0.4, 0, 0));
	//platform_07->setShininess(100);
	//platform_07->setFog(fog);
	//platform_07->setReflectFactor(vec2(0.2, 0.5));
	//platform_07->setEta(0.5);
	...
	////platform_07->setSpeed(5);
	//platform_08->setKd(vec3(0.4, 0, 0));
	//platform_08->setKa(vec3(0.4, 0, 0));
	//platform_08->setKs(vec3(0.4, 0, 0));
	//platform_08->setShininess(100);
	//platform_08->setFog(fog);
	//platform_08->setReflectFactor(vec2(0.2, 0.5));
	//platform_08->setEta(0.5);
	...
	//Cube* platform_09 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	////platform_07->setSpeed(5);
	//platform_09->setKd(vec3(0.4, 0, 0));
	//platform_09->setKa(vec3(0.4, 0, 0));
	//platform_09->setKs(vec3(0.4, 0, 0));
	//platform_09->setShininess(100);
	//platform_09->setFog(fog);
	//platform_09->setReflectFactor(vec2(0.2, 0.5));
	//platform_09->setEta(0.5);
	...
	//platform_07->setSpeed(5);
	platform_10->setKd(vec3(0.4, 0, 0));
	platform_10->setKa(vec3(0.4, 0, 0));
	platform_10->setKs(vec3(0.4, 0, 0));
	...
	//platform_07->setSpeed(5);
	platform_11->setKd(vec3(0.4, 0, 0));
	platform_11->setKa(vec3(0.4, 0, 0));
	platform_11->setKs(vec3(0.4, 0, 0));
	...
	//platform_07->setSpeed(5);
	platform_12->setKd(vec3(0.4, 0, 0));
	platform_12->setKa(vec3(0.4, 0, 0));
	platform_12->setKs(vec3(0.4, 0, 0));
	...
	//platform_07->setSpeed(5);
	platform_13->setKd(vec3(0.4, 0, 0));
	platform_13->setKa(vec3(0.4, 0, 0));
	platform_13->setKs(vec3(0.4, 0, 0));
	...
	//platform_07->setSpeed(5);
	platform_14->setKd(vec3(0.4, 0, 0));
	platform_14->setKa(vec3(0.4, 0, 0));
	platform_14->setKs(vec3(0.4, 0, 0));
	...
	//platform_07->setSpeed(5);
	platform_15->setKd(vec3(0.4, 0, 0));
	platform_15->setKa(vec3(0.4, 0, 0));
	platform_15->setKs(vec3(0.4, 0, 0));
	platform_15->setShininess(100);
	platform_15->setFog(fog);
	platform_15->setReflectFactor(vec2(0.2, 0.5));
	platform_15->setEta(0.5);
	platform_15->setCubeMapUnit(3);
	platform_15->setSpeed(5);
	platform_15->postTrans(glm::translate(vec3(0, 50.0, 70)));
	//platform_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform_15->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform_15->setShadowTex(shadow_map_id);
	platform_15->setType("Cube");
	platform_15->setName("Test Platform");
	stationary_list.push_back(platform_15);

	//steps inside to second platform
	Cube* platform_16 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform_07->setSpeed(5);
	platform_16->setKd(vec3(0.4, 0, 0));
	platform_16->setKa(vec3(0.4, 0, 0));
	platform_16->setKs(vec3(0.4, 0, 0));
	platform_16->setShininess(100);
	platform_16->setFog(fog);
	platform_16->setReflectFactor(vec2(0.2, 0.5));
	platform_16->setEta(0.5);
	platform_16->setCubeMapUnit(3);
	platform_16->setSpeed(5);
	platform_16->postTrans(glm::translate(vec3(-35.0, 55.0, 50)));
	//platform_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform_16->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform_16->setShadowTex(shadow_map_id);
	platform_16->setType("Cube");
	platform_16->setName("Test Platform");
	stationary_list.push_back(platform_16);

	//steps inside to second platform
	Cube* platform_17 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform_07->setSpeed(5);
	platform_17->setKd(vec3(0.4, 0, 0));
	platform_17->setKa(vec3(0.4, 0, 0));
	platform_17->setKs(vec3(0.4, 0, 0));
	platform_17->setShininess(100);
	platform_17->setFog(fog);
	platform_17->setReflectFactor(vec2(0.2, 0.5));
	platform_17->setEta(0.5);
	platform_17->setCubeMapUnit(3);
	platform_17->setSpeed(5);
	platform_17->postTrans(glm::translate(vec3(-35.0, 60.0, 40)));
	//platform_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform_17->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform_17->setShadowTex(shadow_map_id);
	platform_17->setType("Cube");
	platform_17->setName("Test Platform");
	stationary_list.push_back(platform_17);

	//steps inside to second platform
	Cube* platform_18 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform_07->setSpeed(5);
	platform_18->setKd(vec3(0.4, 0, 0));
	platform_18->setKa(vec3(0.4, 0, 0));
	platform_18->setKs(vec3(0.4, 0, 0));
	platform_18->setShininess(100);
	platform_18->setFog(fog);
	platform_18->setReflectFactor(vec2(0.2, 0.5));
	platform_18->setEta(0.5);
	platform_18->setCubeMapUnit(3);
	platform_18->setSpeed(5);
	platform_18->postTrans(glm::translate(vec3(-35.0, 65.0, 30)));
	//platform_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform_18->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform_18->setShadowTex(shadow_map_id);
	platform_18->setType("Cube");
	platform_18->setName("Test Platform");
	stationary_list.push_back(platform_18);

	//second platform inside
	Cube* platform_19 = new Cube(-40.0, 40.0, -0.5, 0.5, -10, 10);
	//platform_07->setSpeed(5);
	platform_19->setKd(vec3(0.4, 0, 0));
	platform_19->setKa(vec3(0.4, 0, 0));
	platform_19->setKs(vec3(0.4, 0, 0));
	platform_19->setShininess(100);
	platform_19->setFog(fog);
	platform_19->setReflectFactor(vec2(0.2, 0.5));
	platform_19->setEta(0.5);
	platform_19->setCubeMapUnit(3);
	platform_19->setSpeed(5);
	platform_19->postTrans(glm::translate(vec3(0, 70.0, 10)));
	//platform_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform_19->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform_19->setShadowTex(shadow_map_id);
	platform_19->setType("Cube");
	platform_19->setName("Test Platform");
	stationary_list.push_back(platform_19);

	//steps inside to third platform
	Cube* platform_20 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform_07->setSpeed(5);
	platform_20->setKd(vec3(0.4, 0, 0));
	platform_20->setKa(vec3(0.4, 0, 0));
	platform_20->setKs(vec3(0.4, 0, 0));
	platform_20->setShininess(100);
	platform_20->setFog(fog);
	platform_20->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_21->setKd(vec3(0.4, 0, 0));
	platform_21->setKa(vec3(0.4, 0, 0));
	platform_21->setKs(vec3(0.4, 0, 0));
	platform_21->setShininess(100);
	platform_21->setFog(fog);
	platform_21->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_22->setKd(vec3(0.4, 0, 0));
	platform_22->setKa(vec3(0.4, 0, 0));
	platform_22->setKs(vec3(0.4, 0, 0));
	platform_22->setShininess(100);
	platform_22->setFog(fog);
	platform_22->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_23->setKd(vec3(0.4, 0, 0));
	platform_23->setKa(vec3(0.4, 0, 0));
	platform_23->setKs(vec3(0.4, 0, 0));
	platform_23->setShininess(100);
	platform_23->setFog(fog);
	platform_23->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_24->setKd(vec3(0.4, 0, 0));
	platform_24->setKa(vec3(0.4, 0, 0));
	platform_24->setKs(vec3(0.4, 0, 0));
	platform_24->setShininess(100);
	platform_24->setFog(fog);
	platform_24->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_25->setKd(vec3(0.4, 0, 0));
	platform_25->setKa(vec3(0.4, 0, 0));
	platform_25->setKs(vec3(0.4, 0, 0));
	platform_25->setShininess(100);
	platform_25->setFog(fog);
	platform_25->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_26->setKd(vec3(0.4, 0, 0));
	platform_26->setKa(vec3(0.4, 0, 0));
	platform_26->setKs(vec3(0.4, 0, 0));
	platform_26->setShininess(100);
	platform_26->setFog(fog);
	platform_26->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_27->setKd(vec3(0.4, 0, 0));
	platform_27->setKa(vec3(0.4, 0, 0));
	platform_27->setKs(vec3(0.4, 0, 0));
	platform_27->setShininess(100);
	platform_27->setFog(fog);
	platform_27->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_28->setKd(vec3(0.4, 0, 0));
	platform_28->setKa(vec3(0.4, 0, 0));
	platform_28->setKs(vec3(0.4, 0, 0));
	platform_28->setShininess(100);
	platform_28->setFog(fog);
	platform_28->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_29->setKd(vec3(0.4, 0, 0));
	platform_29->setKa(vec3(0.4, 0, 0));
	platform_29->setKs(vec3(0.4, 0, 0));
	platform_29->setShininess(100);
	platform_29->setFog(fog);
	platform_29->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_30->setKd(vec3(0.4, 0, 0));
	platform_30->setKa(vec3(0.4, 0, 0));
	platform_30->setKs(vec3(0.4, 0, 0));
	platform_30->setShininess(100);
	platform_30->setFog(fog);
	platform_30->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_31->setKd(vec3(0.4, 0, 0));
	platform_31->setKa(vec3(0.4, 0, 0));
	platform_31->setKs(vec3(0.4, 0, 0));
	platform_31->setShininess(100);
	platform_31->setFog(fog);
	platform_31->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_32->setKd(vec3(0.4, 0, 0));
	platform_32->setKa(vec3(0.4, 0, 0));
	platform_32->setKs(vec3(0.4, 0, 0));
	platform_32->setShininess(100);
	platform_32->setFog(fog);
	platform_32->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_33->setKd(vec3(0.4, 0, 0));
	platform_33->setKa(vec3(0.4, 0, 0));
	platform_33->setKs(vec3(0.4, 0, 0));
	platform_33->setShininess(100);
	platform_33->setFog(fog);
	platform_33->setReflectFactor(vec2(0.2, 0.5));
	...
	//platform_07->setSpeed(5);
	platform_34->setKd(vec3(0.4, 0, 0));
	platform_34->setKa(vec3(0.4, 0, 0));
	platform_34->setKs(vec3(0.4, 0, 0));
	platform_34->setShininess(100);
	platform_34->setFog(fog);
	platform_34->setReflectFactor(vec2(0.2, 0.5));
	platform_34->setEta(0.5);
	platform_34->setCubeMapUnit(3);
	platform_34->setSpeed(5);
	platform_34->postTrans(glm::translate(vec3(-35.0, 140.0, 40)));
	//platform_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform_34->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform_34->setShadowTex(shadow_map_id);
	platform_34->setType("Cube");
	platform_34->setName("Test Platform");
	stationary_list.push_back(platform_34);

	//steps inside to sixth platform
	Cube* platform_35 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform_07->setSpeed(5);
	platform_35->setKd(vec3(0.4, 0, 0));
	platform_35->setKa(vec3(0.4, 0, 0));
	platform_35->setKs(vec3(0.4, 0, 0));
	platform_35->setShininess(100);
	platform_35->setFog(fog);
	platform_35->setReflectFactor(vec2(0.2, 0.5));
	platform_35->setEta(0.5);
	platform_35->setCubeMapUnit(3);
	platform_35->setSpeed(5);
	platform_35->postTrans(glm::translate(vec3(-35.0, 145.0, 30)));
	//platform_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform_35->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform_35->setShadowTex(shadow_map_id);
	platform_35->setType("Cube");
	platform_35->setName("Test Platform");
	stationary_list.push_back(platform_35);

	//sixth platform inside
	Cube* platform_36 = new Cube(-40.0, 80.0, -0.5, 0.5, -10, 10);
	//platform_07->setSpeed(5);
	platform_36->setKd(vec3(0.4, 0, 0));
	platform_36->setKa(vec3(0.4, 0, 0));
	platform_36->setKs(vec3(0.4, 0, 0));
	platform_36->setShininess(100);
	platform_36->setFog(fog);
	platform_36->setReflectFactor(vec2(0.2, 0.5));
	platform_36->setEta(0.5);
	platform_36->setCubeMapUnit(3);
	platform_36->setSpeed(5);
	platform_36->postTrans(glm::translate(vec3(0, 150.0, 10)));
	//platform_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform_36->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform_36->setShadowTex(shadow_map_id);
	platform_36->setType("Cube");
	platform_36->setName("Test Platform");
	stationary_list.push_back(platform_36);

	//sixth platform inside 2
	Cube* platform_37 = new Cube(-30.0, 80.0, -0.5, 0.5, -40, 40);
	//platform_07->setSpeed(5);
	platform_37->setKd(vec3(0.4, 0, 0));
	platform_37->setKa(vec3(0.4, 0, 0));
	platform_37->setKs(vec3(0.4, 0, 0));
	platform_37->setShininess(100);
	platform_37->setFog(fog);
	platform_37->setReflectFactor(vec2(0.2, 0.5));
	platform_37->setEta(0.5);
	platform_37->setCubeMapUnit(3);
	platform_37->setSpeed(5);
	platform_37->postTrans(glm::translate(vec3(0, 150.0, 40)));
	//platform_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform_37->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform_37->setShadowTex(shadow_map_id);
	platform_37->setType("Cube");
	platform_37->setName("Test Platform");
	stationary_list.push_back(platform_37);

	//wall
	Cube* platform2_01 = new Cube(-40, 40.0, -20, 100, -0.5, 0.5);
	//platform2_01->setSpeed(5);
	platform2_01->setKd(vec3(0.4, 0, 0.0));
	platform2_01->setKa(vec3(0.4, 0, 0.0));
	platform2_01->setKs(vec3(0.4, 0, 0.0));
	platform2_01->setShininess(100);
	platform2_01->setFog(fog);
	platform2_01->setReflectFactor(vec2(0.2, 0.5));
	platform2_01->setEta(0.5);
	platform2_01->setCubeMapUnit(3);
	platform2_01->setSpeed(5);
	platform2_01->postTrans(glm::translate(vec3(120, 50.0, 0)));
	//platform2_01->setAABB(AABB(vec3(-10.0, -0.5, -10.0), vec3(10.0, 0.5, 10.0)));
	platform2_01->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_01->setShadowTex(shadow_map_id);
	platform2_01->setType("Cube");
	platform2_01->setName("Test Platform");
	stationary_list.push_back(platform2_01);

	//wall
	Cube* platform2_02 = new Cube(-40, 40, -30, 100, -0.5, 0.5);
	//platform2_01->setSpeed(5);
	platform2_02->setKd(vec3(0.4, 0, 0));
	platform2_02->setKa(vec3(0.4, 0, 0));
	platform2_02->setKs(vec3(0.4, 0, 0));
	platform2_02->setShininess(100);
	platform2_02->setFog(fog);
	platform2_02->setReflectFactor(vec2(0.2, 0.5));
	platform2_02->setEta(0.5);
	platform2_02->setCubeMapUnit(3);
	platform2_02->setSpeed(5);
	platform2_02->postTrans(glm::translate(vec3(120, 50.0, 80)));
	//platform2_02->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_02->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_02->setShadowTex(shadow_map_id);
	platform2_02->setType("Cube");
	platform2_02->setName("Test Platform");
	stationary_list.push_back(platform2_02);

	//wall
	Cube* platform2_03 = new Cube(-.5, 0.5, -30, 100, -40, 40);
	//platform2_01->setSpeed(5);
	platform2_03->setKd(vec3(0., 0., 0));
	platform2_03->setKa(vec3(0.4, 0, 0));
	platform2_03->setKs(vec3(0.4, 0, 0));
	platform2_03->setShininess(100);
	platform2_03->setFog(fog);
	platform2_03->setReflectFactor(vec2(0.2, 0.5));
	platform2_03->setEta(0.5);
	platform2_03->setCubeMapUnit(3);
	platform2_03->setSpeed(5);
	platform2_03->postTrans(glm::translate(vec3(160, 50.0, 40)));
	//platform2_03->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_03->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_03->setShadowTex(shadow_map_id);
	platform2_03->setType("Cube");
	platform2_03->setName("Test Platform");
	stationary_list.push_back(platform2_03);


	//wall
	Cube* platform2_04 = new Cube(-.5, 0.5, -30, 100, -40, 40);
	//platform2_01->setSpeed(5);
	platform2_04->setKd(vec3(0.4, 0, 0));
	platform2_04->setKa(vec3(0.4, 0, 0));
	platform2_04->setKs(vec3(0.4, 0, 0));
	platform2_04->setShininess(100);
	platform2_04->setFog(fog);
	platform2_04->setReflectFactor(vec2(0.2, 0.5));
	platform2_04->setEta(0.5);
	platform2_04->setCubeMapUnit(3);
	platform2_04->setSpeed(5);
	platform2_04->postTrans(glm::translate(vec3(80, 50.0, 40)));
	//platform2_04->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_04->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_04->setShadowTex(shadow_map_id);
	platform2_04->setType("Cube");
	platform2_04->setName("Test Platform");
	stationary_list.push_back(platform2_04);

	//door wall
	Cube* platform2_05 = new Cube(-40, -5.0, -30, -20, -0.5, 0.5);
	//platform2_05->setSpeed(5);
	platform2_05->setKd(vec3(0.4, 0, 0));
	platform2_05->setKa(vec3(0.4, 0, 0));
	platform2_05->setKs(vec3(0.4, 0, 0));
	platform2_05->setShininess(100);
	platform2_05->setFog(fog);
	platform2_05->setReflectFactor(vec2(0.2, 0.5));
	platform2_05->setEta(0.5);
	platform2_05->setCubeMapUnit(3);
	platform2_05->setSpeed(5);
	platform2_05->postTrans(glm::translate(vec3(120, 50.0, 0.0)));
	//platform2_05->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_05->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_05->setShadowTex(shadow_map_id);
	platform2_05->setType("Cube");
	platform2_05->setName("Test Platform");
	stationary_list.push_back(platform2_05);

	//door wall
	Cube* platform2_06 = new Cube(5, 40, -30, -20, -0.5, 0.5);
	//platform2_06->setSpeed(5);
	platform2_06->setKd(vec3(0.4, 0, 0));
	platform2_06->setKa(vec3(0.4, 0, 0));
	platform2_06->setKs(vec3(0.4, 0, 0));
	platform2_06->setShininess(100);
	platform2_06->setFog(fog);
	platform2_06->setReflectFactor(vec2(0.2, 0.5));
	platform2_06->setEta(0.5);
	platform2_06->setCubeMapUnit(3);
	platform2_06->setSpeed(5);
	platform2_06->postTrans(glm::translate(vec3(120, 50.0, 0.0)));
	//platform2_06->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_06->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_06->setShadowTex(shadow_map_id);
	platform2_06->setType("Cube");
	platform2_06->setName("Test Platform");
	stationary_list.push_back(platform2_06);


	//steps entrance
	Cube* platform2_07 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_07->setKd(vec3(0.4, 0, 0));
	platform2_07->setKa(vec3(0.4, 0, 0));
	platform2_07->setKs(vec3(0.4, 0, 0));
	platform2_07->setShininess(100);
	platform2_07->setFog(fog);
	platform2_07->setReflectFactor(vec2(0.2, 0.5));
	platform2_07->setEta(0.5);
	platform2_07->setCubeMapUnit(3);
	platform2_07->setSpeed(5);
	platform2_07->postTrans(glm::translate(vec3(120, 15.0, -10.0)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_07->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_07->setShadowTex(shadow_map_id);
	platform2_07->setType("Cube");
	platform2_07->setName("Test Platform");
	stationary_list.push_back(platform2_07);

	//steps entrance
	Cube* platform2_08 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_08->setKd(vec3(0.4, 0, 0));
	platform2_08->setKa(vec3(0.4, 0, 0));
	platform2_08->setKs(vec3(0.4, 0, 0));
	platform2_08->setShininess(100);
	platform2_08->setFog(fog);
	platform2_08->setReflectFactor(vec2(0.2, 0.5));
	platform2_08->setEta(0.5);
	platform2_08->setCubeMapUnit(3);
	platform2_08->setSpeed(5);
	platform2_08->postTrans(glm::translate(vec3(120, 10.0, -20.0)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_08->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_08->setShadowTex(shadow_map_id);
	platform2_08->setType("Cube");
	platform2_08->setName("Test Platform");
	stationary_list.push_back(platform2_08);

	//steps entrance
	Cube* platform2_09 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_09->setKd(vec3(0.4, 0, 0));
	platform2_09->setKa(vec3(0.4, 0, 0));
	platform2_09->setKs(vec3(0.4, 0, 0));
	platform2_09->setShininess(100);
	platform2_09->setFog(fog);
	platform2_09->setReflectFactor(vec2(0.2, 0.5));
	platform2_09->setEta(0.5);
	platform2_09->setCubeMapUnit(3);
	platform2_09->setSpeed(5);
	platform2_09->postTrans(glm::translate(vec3(120, 5, -30.0)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_09->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_09->setShadowTex(shadow_map_id);
	platform2_09->setType("Cube");
	platform2_09->setName("Test Platform");
	stationary_list.push_back(platform2_09);

	//steps inside to first platform
	Cube* platform2_10 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_10->setKd(vec3(0.4, 0, 0));
	platform2_10->setKa(vec3(0.4, 0, 0));
	platform2_10->setKs(vec3(0.4, 0, 0));
	platform2_10->setShininess(100);
	platform2_10->setFog(fog);
	platform2_10->setReflectFactor(vec2(0.2, 0.5));
	platform2_10->setEta(0.5);
	platform2_10->setCubeMapUnit(3);
	platform2_10->setSpeed(5);
	platform2_10->postTrans(glm::translate(vec3(155.0, 25.0, 10)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_10->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_10->setShadowTex(shadow_map_id);
	platform2_10->setType("Cube");
	platform2_10->setName("Test Platform");
	stationary_list.push_back(platform2_10);

	//steps inside to first platform
	Cube* platform2_11 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_11->setKd(vec3(0.4, 0, 0));
	platform2_11->setKa(vec3(0.4, 0, 0));
	platform2_11->setKs(vec3(0.4, 0, 0));
	platform2_11->setShininess(100);
	platform2_11->setFog(fog);
	platform2_11->setReflectFactor(vec2(0.2, 0.5));
	platform2_11->setEta(0.5);
	platform2_11->setCubeMapUnit(3);
	platform2_11->setSpeed(5);
	platform2_11->postTrans(glm::translate(vec3(155.0, 30.0, 20)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_11->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_11->setShadowTex(shadow_map_id);
	platform2_11->setType("Cube");
	platform2_11->setName("Test Platform");
	stationary_list.push_back(platform2_11);

	//steps inside to first platform
	Cube* platform2_12 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_12->setKd(vec3(0.4, 0, 0));
	platform2_12->setKa(vec3(0.4, 0, 0));
	platform2_12->setKs(vec3(0.4, 0, 0));
	platform2_12->setShininess(100);
	platform2_12->setFog(fog);
	platform2_12->setReflectFactor(vec2(0.2, 0.5));
	platform2_12->setEta(0.5);
	platform2_12->setCubeMapUnit(3);
	platform2_12->setSpeed(5);
	platform2_12->postTrans(glm::translate(vec3(155.0, 35.0, 30)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_12->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_12->setShadowTex(shadow_map_id);
	platform2_12->setType("Cube");
	platform2_12->setName("Test Platform");
	stationary_list.push_back(platform2_12);

	//steps inside to first platform
	Cube* platform2_13 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_13->setKd(vec3(0.4, 0, 0));
	platform2_13->setKa(vec3(0.4, 0, 0));
	platform2_13->setKs(vec3(0.4, 0, 0));
	platform2_13->setShininess(100);
	platform2_13->setFog(fog);
	platform2_13->setReflectFactor(vec2(0.2, 0.5));
	platform2_13->setEta(0.5);
	platform2_13->setCubeMapUnit(3);
	platform2_13->setSpeed(5);
	platform2_13->postTrans(glm::translate(vec3(155.0, 40.0, 40)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_13->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_13->setShadowTex(shadow_map_id);
	platform2_13->setType("Cube");
	platform2_13->setName("Test Platform");
	stationary_list.push_back(platform2_13);

	//steps inside to first platform
	Cube* platform2_14 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_14->setKd(vec3(0.4, 0, 0));
	platform2_14->setKa(vec3(0.4, 0, 0));
	platform2_14->setKs(vec3(0.4, 0, 0));
	platform2_14->setShininess(100);
	platform2_14->setFog(fog);
	platform2_14->setReflectFactor(vec2(0.2, 0.5));
	platform2_14->setEta(0.5);
	platform2_14->setCubeMapUnit(3);
	platform2_14->setSpeed(5);
	platform2_14->postTrans(glm::translate(vec3(155.0, 45.0, 50)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_14->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_14->setShadowTex(shadow_map_id);
	platform2_14->setType("Cube");
	platform2_14->setName("Test Platform");
	stationary_list.push_back(platform2_14);

	//first platform inside
	Cube* platform2_15 = new Cube(-40.0, 40.0, -0.5, 0.5, -10, 10);
	//platform2_07->setSpeed(5);
	platform2_15->setKd(vec3(0.4, 0, 0));
	platform2_15->setKa(vec3(0.4, 0, 0));
	platform2_15->setKs(vec3(0.4, 0, 0));
	platform2_15->setShininess(100);
	platform2_15->setFog(fog);
	platform2_15->setReflectFactor(vec2(0.2, 0.5));
	platform2_15->setEta(0.5);
	platform2_15->setCubeMapUnit(3);
	platform2_15->setSpeed(5);
	platform2_15->postTrans(glm::translate(vec3(120, 50.0, 70)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_15->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_15->setShadowTex(shadow_map_id);
	platform2_15->setType("Cube");
	platform2_15->setName("Test Platform");
	stationary_list.push_back(platform2_15);

	//steps inside to second platform
	Cube* platform2_16 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_16->setKd(vec3(0.4, 0, 0));
	platform2_16->setKa(vec3(0.4, 0, 0));
	platform2_16->setKs(vec3(0.4, 0, 0));
	platform2_16->setShininess(100);
	platform2_16->setFog(fog);
	platform2_16->setReflectFactor(vec2(0.2, 0.5));
	platform2_16->setEta(0.5);
	platform2_16->setCubeMapUnit(3);
	platform2_16->setSpeed(5);
	platform2_16->postTrans(glm::translate(vec3(85.0, 55.0, 50)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_16->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_16->setShadowTex(shadow_map_id);
	platform2_16->setType("Cube");
	platform2_16->setName("Test Platform");
	stationary_list.push_back(platform2_16);

	//steps inside to second platform
	Cube* platform2_17 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_17->setKd(vec3(0.4, 0, 0));
	platform2_17->setKa(vec3(0.4, 0, 0));
	platform2_17->setKs(vec3(0.4, 0, 0));
	platform2_17->setShininess(100);
	platform2_17->setFog(fog);
	platform2_17->setReflectFactor(vec2(0.2, 0.5));
	platform2_17->setEta(0.5);
	platform2_17->setCubeMapUnit(3);
	platform2_17->setSpeed(5);
	platform2_17->postTrans(glm::translate(vec3(85.0, 60.0, 40)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_17->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_17->setShadowTex(shadow_map_id);
	platform2_17->setType("Cube");
	platform2_17->setName("Test Platform");
	stationary_list.push_back(platform2_17);

	//steps inside to second platform
	Cube* platform2_18 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_18->setKd(vec3(0.4, 0, 0));
	platform2_18->setKa(vec3(0.4, 0, 0));
	platform2_18->setKs(vec3(0.4, 0, 0));
	platform2_18->setShininess(100);
	platform2_18->setFog(fog);
	platform2_18->setReflectFactor(vec2(0.2, 0.5));
	platform2_18->setEta(0.5);
	platform2_18->setCubeMapUnit(3);
	platform2_18->setSpeed(5);
	platform2_18->postTrans(glm::translate(vec3(85.0, 65.0, 30)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_18->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_18->setShadowTex(shadow_map_id);
	platform2_18->setType("Cube");
	platform2_18->setName("Test Platform");
	stationary_list.push_back(platform2_18);

	//second platform inside
	Cube* platform2_19 = new Cube(-40.0, 40.0, -0.5, 0.5, -10, 10);
	//platform2_07->setSpeed(5);
	platform2_19->setKd(vec3(0.4, 0, 0));
	platform2_19->setKa(vec3(0.4, 0, 0));
	platform2_19->setKs(vec3(0.4, 0, 0));
	platform2_19->setShininess(100);
	platform2_19->setFog(fog);
	platform2_19->setReflectFactor(vec2(0.2, 0.5));
	platform2_19->setEta(0.5);
	platform2_19->setCubeMapUnit(3);
	platform2_19->setSpeed(5);
	platform2_19->postTrans(glm::translate(vec3(120, 70.0, 10)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_19->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_19->setShadowTex(shadow_map_id);
	platform2_19->setType("Cube");
	platform2_19->setName("Test Platform");
	stationary_list.push_back(platform2_19);

	//steps inside to third platform
	Cube* platform2_20 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_20->setKd(vec3(0.4, 0, 0));
	platform2_20->setKa(vec3(0.4, 0, 0));
	platform2_20->setKs(vec3(0.4, 0, 0));
	platform2_20->setShininess(100);
	platform2_20->setFog(fog);
	platform2_20->setReflectFactor(vec2(0.2, 0.5));
	platform2_20->setEta(0.5);
	platform2_20->setCubeMapUnit(3);
	platform2_20->setSpeed(5);
	platform2_20->postTrans(glm::translate(vec3(155.0, 75.0, 30)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_20->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_20->setShadowTex(shadow_map_id);
	platform2_20->setType("Cube");
	platform2_20->setName("Test Platform");
	stationary_list.push_back(platform2_20);

	//steps inside to third platform
	Cube* platform2_21 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_21->setKd(vec3(0.4, 0, 0));
	platform2_21->setKa(vec3(0.4, 0, 0));
	platform2_21->setKs(vec3(0.4, 0, 0));
	platform2_21->setShininess(100);
	platform2_21->setFog(fog);
	platform2_21->setReflectFactor(vec2(0.2, 0.5));
	platform2_21->setEta(0.5);
	platform2_21->setCubeMapUnit(3);
	platform2_21->setSpeed(5);
	platform2_21->postTrans(glm::translate(vec3(155.0, 80.0, 40)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_21->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_21->setShadowTex(shadow_map_id);
	platform2_21->setType("Cube");
	platform2_21->setName("Test Platform");
	stationary_list.push_back(platform2_21);

	//steps inside to third platform
	Cube* platform2_22 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_22->setKd(vec3(0.4, 0, 0));
	platform2_22->setKa(vec3(0.4, 0, 0));
	platform2_22->setKs(vec3(0.4, 0, 0));
	platform2_22->setShininess(100);
	platform2_22->setFog(fog);
	platform2_22->setReflectFactor(vec2(0.2, 0.5));
	platform2_22->setEta(0.5);
	platform2_22->setCubeMapUnit(3);
	platform2_22->setSpeed(5);
	platform2_22->postTrans(glm::translate(vec3(155.0, 85.0, 50)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_22->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_22->setShadowTex(shadow_map_id);
	platform2_22->setType("Cube");
	platform2_22->setName("Test Platform");
	stationary_list.push_back(platform2_22);

	//third platform inside
	Cube* platform2_23 = new Cube(-40.0, 40.0, -0.5, 0.5, -10, 10);
	//platform2_07->setSpeed(5);
	platform2_23->setKd(vec3(0.4, 0, 0));
	platform2_23->setKa(vec3(0.4, 0, 0));
	platform2_23->setKs(vec3(0.4, 0, 0));
	platform2_23->setShininess(100);
	platform2_23->setFog(fog);
	platform2_23->setReflectFactor(vec2(0.2, 0.5));
	platform2_23->setEta(0.5);
	platform2_23->setCubeMapUnit(3);
	platform2_23->setSpeed(5);
	platform2_23->postTrans(glm::translate(vec3(120, 90.0, 70)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_23->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_23->setShadowTex(shadow_map_id);
	platform2_23->setType("Cube");
	platform2_23->setName("Test Platform");
	stationary_list.push_back(platform2_23);

	//steps inside to fourth platform
	Cube* platform2_24 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_24->setKd(vec3(0.4, 0, 0));
	platform2_24->setKa(vec3(0.4, 0, 0));
	platform2_24->setKs(vec3(0.4, 0, 0));
	platform2_24->setShininess(100);
	platform2_24->setFog(fog);
	platform2_24->setReflectFactor(vec2(0.2, 0.5));
	platform2_24->setEta(0.5);
	platform2_24->setCubeMapUnit(3);
	platform2_24->setSpeed(5);
	platform2_24->postTrans(glm::translate(vec3(85.0, 95.0, 50)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_24->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_24->setShadowTex(shadow_map_id);
	platform2_24->setType("Cube");
	platform2_24->setName("Test Platform");
	stationary_list.push_back(platform2_24);

	//steps inside to fourth platform
	Cube* platform2_25 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_25->setKd(vec3(0.4, 0, 0));
	platform2_25->setKa(vec3(0.4, 0, 0));
	platform2_25->setKs(vec3(0.4, 0, 0));
	platform2_25->setShininess(100);
	platform2_25->setFog(fog);
	platform2_25->setReflectFactor(vec2(0.2, 0.5));
	platform2_25->setEta(0.5);
	platform2_25->setCubeMapUnit(3);
	platform2_25->setSpeed(5);
	platform2_25->postTrans(glm::translate(vec3(85.0, 100.0, 40)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_25->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_25->setShadowTex(shadow_map_id);
	platform2_25->setType("Cube");
	platform2_25->setName("Test Platform");
	stationary_list.push_back(platform2_25);

	//steps inside to fourth platform
	Cube* platform2_26 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_26->setKd(vec3(0.4, 0, 0));
	platform2_26->setKa(vec3(0.4, 0, 0));
	platform2_26->setKs(vec3(0.4, 0, 0));
	platform2_26->setShininess(100);
	platform2_26->setFog(fog);
	platform2_26->setReflectFactor(vec2(0.2, 0.5));
	platform2_26->setEta(0.5);
	platform2_26->setCubeMapUnit(3);
	platform2_26->setSpeed(5);
	platform2_26->postTrans(glm::translate(vec3(85.0, 105.0, 30)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_26->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_26->setShadowTex(shadow_map_id);
	platform2_26->setType("Cube");
	platform2_26->setName("Test Platform");
	stationary_list.push_back(platform2_26);

	//fourth platform inside
	Cube* platform2_27 = new Cube(-40.0, 40.0, -0.5, 0.5, -10, 10);
	//platform2_07->setSpeed(5);
	platform2_27->setKd(vec3(0.4, 0, 0));
	platform2_27->setKa(vec3(0.4, 0, 0));
	platform2_27->setKs(vec3(0.4, 0, 0));
	platform2_27->setShininess(100);
	platform2_27->setFog(fog);
	platform2_27->setReflectFactor(vec2(0.2, 0.5));
	platform2_27->setEta(0.5);
	platform2_27->setCubeMapUnit(3);
	platform2_27->setSpeed(5);
	platform2_27->postTrans(glm::translate(vec3(120, 110.0, 10)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_27->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_27->setShadowTex(shadow_map_id);
	platform2_27->setType("Cube");
	platform2_27->setName("Test Platform");
	stationary_list.push_back(platform2_27);

	//steps inside to fifth platform
	Cube* platform2_28 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_28->setKd(vec3(0.4, 0, 0));
	platform2_28->setKa(vec3(0.4, 0, 0));
	platform2_28->setKs(vec3(0.4, 0, 0));
	platform2_28->setShininess(100);
	platform2_28->setFog(fog);
	platform2_28->setReflectFactor(vec2(0.2, 0.5));
	platform2_28->setEta(0.5);
	platform2_28->setCubeMapUnit(3);
	platform2_28->setSpeed(5);
	platform2_28->postTrans(glm::translate(vec3(155.0, 115.0, 30)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_28->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_28->setShadowTex(shadow_map_id);
	platform2_28->setType("Cube");
	platform2_28->setName("Test Platform");
	stationary_list.push_back(platform2_28);

	//steps inside to fifth platform
	Cube* platform2_29 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_29->setKd(vec3(0.4, 0, 0));
	platform2_29->setKa(vec3(0.4, 0, 0));
	platform2_29->setKs(vec3(0.4, 0, 0));
	platform2_29->setShininess(100);
	platform2_29->setFog(fog);
	platform2_29->setReflectFactor(vec2(0.2, 0.5));
	platform2_29->setEta(0.5);
	platform2_29->setCubeMapUnit(3);
	platform2_29->setSpeed(5);
	platform2_29->postTrans(glm::translate(vec3(155.0, 120.0, 40)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_29->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_29->setShadowTex(shadow_map_id);
	platform2_29->setType("Cube");
	platform2_29->setName("Test Platform");
	stationary_list.push_back(platform2_29);

	//steps inside to fifth platform
	Cube* platform2_30 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_30->setKd(vec3(0.4, 0, 0));
	platform2_30->setKa(vec3(0.4, 0, 0));
	platform2_30->setKs(vec3(0.4, 0, 0));
	platform2_30->setShininess(100);
	platform2_30->setFog(fog);
	platform2_30->setReflectFactor(vec2(0.2, 0.5));
	platform2_30->setEta(0.5);
	platform2_30->setCubeMapUnit(3);
	platform2_30->setSpeed(5);
	platform2_30->postTrans(glm::translate(vec3(155.0, 125.0, 50)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_30->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_30->setShadowTex(shadow_map_id);
	platform2_30->setType("Cube");
	platform2_30->setName("Test Platform");
	stationary_list.push_back(platform2_30);

	//fifth platform inside
	Cube* platform2_31 = new Cube(-40.0, 40.0, -0.5, 0.5, -10, 10);
	//platform2_07->setSpeed(5);
	platform2_31->setKd(vec3(0.4, 0, 0));
	platform2_31->setKa(vec3(0.4, 0, 0));
	platform2_31->setKs(vec3(0.4, 0, 0));
	platform2_31->setShininess(100);
	platform2_31->setFog(fog);
	platform2_31->setReflectFactor(vec2(0.2, 0.5));
	platform2_31->setEta(0.5);
	platform2_31->setCubeMapUnit(3);
	platform2_31->setSpeed(5);
	platform2_31->postTrans(glm::translate(vec3(120, 130.0, 70)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_31->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_31->setShadowTex(shadow_map_id);
	platform2_31->setType("Cube");
	platform2_31->setName("Test Platform");
	stationary_list.push_back(platform2_31);


	//entrance platform
	Cube* platform2_32 = new Cube(-40.0, 40.0, -0.5, 0.5, -10, 10);
	//platform2_07->setSpeed(5);
	platform2_32->setKd(vec3(0.4, 0, 0));
	platform2_32->setKa(vec3(0.4, 0, 0));
	platform2_32->setKs(vec3(0.4, 0, 0));
	platform2_32->setShininess(100);
	platform2_32->setFog(fog);
	platform2_32->setReflectFactor(vec2(0.2, 0.5));
	platform2_32->setEta(0.5);
	platform2_32->setCubeMapUnit(3);
	platform2_32->setSpeed(5);
	platform2_32->postTrans(glm::translate(vec3(120, 20.0, 10)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_32->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_32->setShadowTex(shadow_map_id);
	platform2_32->setType("Cube");
	platform2_32->setName("Test Platform");
	stationary_list.push_back(platform2_32);

	//steps inside to sixth platform
	Cube* platform2_33 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_33->setKd(vec3(0.4, 0, 0));
	platform2_33->setKa(vec3(0.4, 0, 0));
	platform2_33->setKs(vec3(0.4, 0, 0));
	platform2_33->setShininess(100);
	platform2_33->setFog(fog);
	platform2_33->setReflectFactor(vec2(0.2, 0.5));
	platform2_33->setEta(0.5);
	platform2_33->setCubeMapUnit(3);
	platform2_33->setSpeed(5);
	platform2_33->postTrans(glm::translate(vec3(85.0, 135.0, 50)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_33->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_33->setShadowTex(shadow_map_id);
	platform2_33->setType("Cube");
	platform2_33->setName("Test Platform");
	stationary_list.push_back(platform2_33);

	//steps inside to sixth platform
	Cube* platform2_34 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_34->setKd(vec3(0.4, 0, 0));
	platform2_34->setKa(vec3(0.4, 0, 0));
	platform2_34->setKs(vec3(0.4, 0, 0));
	platform2_34->setShininess(100);
	platform2_34->setFog(fog);
	platform2_34->setReflectFactor(vec2(0.2, 0.5));
	platform2_34->setEta(0.5);
	platform2_34->setCubeMapUnit(3);
	platform2_34->setSpeed(5);
	platform2_34->postTrans(glm::translate(vec3(85.0, 140.0, 40)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_34->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_34->setShadowTex(shadow_map_id);
	platform2_34->setType("Cube");
	platform2_34->setName("Test Platform");
	stationary_list.push_back(platform2_34);

	//steps inside to sixth platform
	Cube* platform2_35 = new Cube(-5.0, 5.0, -0.5, 0.5, -1.5, 1.5);
	//platform2_07->setSpeed(5);
	platform2_35->setKd(vec3(0.4, 0, 0));
	platform2_35->setKa(vec3(0.4, 0, 0));
	platform2_35->setKs(vec3(0.4, 0, 0));
	platform2_35->setShininess(100);
	platform2_35->setFog(fog);
	platform2_35->setReflectFactor(vec2(0.2, 0.5));
	platform2_35->setEta(0.5);
	platform2_35->setCubeMapUnit(3);
	platform2_35->setSpeed(5);
	platform2_35->postTrans(glm::translate(vec3(85.0, 145.0, 30)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_35->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_35->setShadowTex(shadow_map_id);
	platform2_35->setType("Cube");
	platform2_35->setName("Test Platform");
	stationary_list.push_back(platform2_35);

	//sixth platform inside
	Cube* platform2_36 = new Cube(-40.0, 40.0, -0.5, 0.5, -10, 10);
	//platform2_07->setSpeed(5);
	platform2_36->setKd(vec3(0.4, 0, 0));
	platform2_36->setKa(vec3(0.4, 0, 0));
	platform2_36->setKs(vec3(0.4, 0, 0));
	platform2_36->setShininess(100);
	platform2_36->setFog(fog);
	platform2_36->setReflectFactor(vec2(0.2, 0.5));
	platform2_36->setEta(0.5);
	platform2_36->setCubeMapUnit(3);
	platform2_36->setSpeed(5);
	platform2_36->postTrans(glm::translate(vec3(120, 150.0, 10)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_36->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_36->setShadowTex(shadow_map_id);
	platform2_36->setType("Cube");
	platform2_36->setName("Test Platform");
	stationary_list.push_back(platform2_36);

	//sixth platform inside 2
	Cube* platform2_37 = new Cube(-30.0, 40.0, -0.5, 0.5, -40, 40);
	//platform2_07->setSpeed(5);
	platform2_37->setKd(vec3(0.4, 0, 0));
	platform2_37->setKa(vec3(0.4, 0, 0));
	platform2_37->setKs(vec3(0.4, 0, 0));
	platform2_37->setShininess(100);
	platform2_37->setFog(fog);
	platform2_37->setReflectFactor(vec2(0.2, 0.5));
	platform2_37->setEta(0.5);
	platform2_37->setCubeMapUnit(3);
	platform2_37->setSpeed(5);
	platform2_37->postTrans(glm::translate(vec3(120, 150.0, 40)));
	//platform2_07->setAABB(AABB(vec3(-1.5, -0.5, -5.0), vec3(1.5, 0.5, 5.0)));
	platform2_37->setShader(sdrCtl.getShader("basic_reflect_refract"));
	platform2_37->setShadowTex(shadow_map_id);
	platform2_37->setType("Cube");
	platform2_37->setName("Test Platform");
	stationary_list.push_back(platform2_37);
